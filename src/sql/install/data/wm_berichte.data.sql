...
insert ignore into wm_berichte (id,name) values ('wm_berichte_erwartet_online','Protokoll Erwartet Online');
insert ignore into wm_berichte (id,name) values ('wm_berichte_losentscheid_stimmzettel','Losentscheide nach Stimmzettel');
insert ignore into wm_berichte (id,name) values ('wm_berichte_los_mindestsitze','Losentscheide nach Mindestsitz');
