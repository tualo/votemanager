...
(system_settings_id,groupname) values
('erp/privatekey','administration'),
('remote-erp/public','administration'),
('remote-erp/token','administration'),
('remote-erp/url','administration')
//
